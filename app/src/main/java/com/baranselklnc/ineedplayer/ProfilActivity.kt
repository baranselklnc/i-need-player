    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userReference?.addValueEventListener(object:ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                binding.profileFullNameText.text= "Full Name: " +snapshot.child("adisoyadi").value.toString()
            }
        ...
        userReference?.addValueEventListener(object:ValueEventListener{ //sonradan
            override fun onDataChange(snapshot: DataSnapshot) {
                binding.profilePositionText.text="About: "+snapshot.child("about").value.toString()
            }
        ...
        binding.profileDeleteButton.setOnClickListener {
           currentUser?.delete()?.addOnCompleteListener{
               if(it.isSuccessful){
                   ...
                   Toast.makeText(applicationContext,"We deleted your all data. Don't leave us alone.",Toast.LENGTH_LONG).show()
