    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.updateactivebutton.setOnClickListener {
            ...
            currentUser!!.updatePassword(updatepassword).addOnCompleteListener{
                    task->
                if(task.isSuccessful){
                    Toast.makeText(applicationContext,"Your password has been updated",Toast.LENGTH_LONG).show()
            ...
            Toast.makeText(applicationContext,"Your new name suits you very well",Toast.LENGTH_LONG).show()
